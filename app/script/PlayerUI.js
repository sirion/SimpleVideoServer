...
define(["ui/tools/DomHelper", "ui/dialog/TagDialog"], function(DomHelper, TagDialog) {
"use strict";
...
PlayerUI.prototype.show = function(domId) {
	...
	var tagsDialog = new TagDialog({
		title: "Edit media tags:"
	});
	tagsDialog.on("ok", function() {
		tagsDialog.hide();
		debugger;
	});
	tagsDialog.on("cancel", function() {
		tagsDialog.hide();
		debugger;
	});
	...
	DomHelper.whenDocumentReady().then(function() {
